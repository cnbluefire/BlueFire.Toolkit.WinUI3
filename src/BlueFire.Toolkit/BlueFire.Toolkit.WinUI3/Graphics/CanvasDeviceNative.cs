...
typeof(CallConvStdcall)}
        ...
        private static unsafe winmdroot.Foundation.HRESULT GetNativeResource(ICanvasResourceWrapperNative* pThis, void* device, float dpi, Guid* iid, void** resource)
        {
            try
            {
                ...
                return __object.GetNativeResource(device, dpi, iid, resource);
            }
            catch (Exception ex)
            {
        ...
        {
            internal delegate* unmanaged[Stdcall]<ICanvasResourceWrapperNative*, global::System.Guid*, void**, winmdroot.Foundation.HRESULT> QueryInterface_1;

            internal delegate* unmanaged[Stdcall]<ICanvasResourceWrapperNative*, uint> AddRef_2;

            internal delegate* unmanaged[Stdcall]<ICanvasResourceWrapperNative*, uint> Release_3;

            internal delegate* unmanaged[Stdcall]<ICanvasResourceWrapperNative*, void*, float, Guid*, void**, winmdroot.Foundation.HRESULT> GetNativeResource_4;
        }
        public static void PopulateVTable(Vtbl* vtable)
        {
            vtable->GetNativeResource_4 = &GetNativeResource;
        }
...
typeof(CallConvStdcall)}
        ...
        private static unsafe winmdroot.Foundation.HRESULT GetOrCreate(ICanvasFactoryNative* pThis, void* device, void* resource, float dpi, void** wrapper)
        {
            try
            {
                winmdroot.Foundation.HRESULT __hr = winmdroot.ComHelpers.UnwrapCCW(pThis, out Interface __object);
                ...
                return __object.GetOrCreate(device, resource, dpi, wrapper);
            }
            catch (Exception ex)
            {
                return (winmdroot.Foundation.HRESULT)ex.HResult;
...
typeof(CallConvStdcall)}
        ...
        private static unsafe winmdroot.Foundation.HRESULT RegisterWrapper(ICanvasFactoryNative* pThis, void* resource, void* wrapper)
        {
            try
            {
                winmdroot.Foundation.HRESULT __hr = winmdroot.ComHelpers.UnwrapCCW(pThis, out Interface __object);
                ...
                return __object.RegisterWrapper(resource, wrapper);
            }
            catch (Exception ex)
            {
                return (winmdroot.Foundation.HRESULT)ex.HResult;
...
typeof(CallConvStdcall)}
        ...
        private static unsafe winmdroot.Foundation.HRESULT UnregisterWrapper(ICanvasFactoryNative* pThis, void* resource)
        {
            try
            {
                winmdroot.Foundation.HRESULT __hr = winmdroot.ComHelpers.UnwrapCCW(pThis, out Interface __object);
                ...
                return __object.UnregisterWrapper(resource);
            }
            catch (Exception ex)
            {
                return (winmdroot.Foundation.HRESULT)ex.HResult;
...
typeof(CallConvStdcall)}
        ...
        private static unsafe winmdroot.Foundation.HRESULT RegisterEffectFactory(ICanvasFactoryNative* pThis, Guid* effectId, void* factory)
        {
            try
            {
                winmdroot.Foundation.HRESULT __hr = winmdroot.ComHelpers.UnwrapCCW(pThis, out Interface __object);
                ...
                return __object.RegisterEffectFactory(effectId, factory);
            }
            catch (Exception ex)
            {
                return (winmdroot.Foundation.HRESULT)ex.HResult;
...
typeof(CallConvStdcall)}
        ...
        private static unsafe winmdroot.Foundation.HRESULT UnregisterEffectFactory(ICanvasFactoryNative* pThis, Guid* effectId)
        {
            try
            {
                winmdroot.Foundation.HRESULT __hr = winmdroot.ComHelpers.UnwrapCCW(pThis, out Interface __object);
                ...
                return __object.UnregisterEffectFactory(effectId);
            }
            catch (Exception ex)
            {
                return (winmdroot.Foundation.HRESULT)ex.HResult;
        ...
        internal struct Vtbl
        {
            ...
            internal delegate* unmanaged[Stdcall]<ICanvasFactoryNative*, void*, void*, float, void**, winmdroot.Foundation.HRESULT> GetOrCreate_7;

            internal delegate* unmanaged[Stdcall]<ICanvasFactoryNative*, void*, void*, winmdroot.Foundation.HRESULT> RegisterWrapper_8;

            internal delegate* unmanaged[Stdcall]<ICanvasFactoryNative*, void*, winmdroot.Foundation.HRESULT> UnregisterWrapper_9;

            internal delegate* unmanaged[Stdcall]<ICanvasFactoryNative*, Guid*, void*, winmdroot.Foundation.HRESULT> RegisterEffectFactory_10;

            internal delegate* unmanaged[Stdcall]<ICanvasFactoryNative*, Guid*, winmdroot.Foundation.HRESULT> UnregisterEffectFactory_11;
        }

        public static void PopulateVTable(Vtbl* vtable)
        {
            vtable->IInspectableVftbl = WinRT.IInspectable.Vftbl.AbiToProjectionVftable;
            vtable->GetOrCreate_7 = &GetOrCreate;
            vtable->RegisterWrapper_8 = &RegisterWrapper;
            vtable->UnregisterWrapper_9 = &UnregisterWrapper;
            vtable->RegisterEffectFactory_10 = &RegisterEffectFactory;
            vtable->UnregisterEffectFactory_11 = &UnregisterEffectFactory;
        }
