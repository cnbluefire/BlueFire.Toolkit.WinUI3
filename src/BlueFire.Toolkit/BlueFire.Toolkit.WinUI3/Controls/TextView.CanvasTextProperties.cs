...
namespace BlueFire.Toolkit.WinUI3.Controls
{
    partial class TextView
    {
        ...
        private CanvasTextDirection GetCanvasTextDirection(FormattedTextProperties textProperties) => textProperties.MutableProperties.FlowDirection switch
        {
            FlowDirection.LeftToRight => CanvasTextDirection.LeftToRightThenTopToBottom,
            _ => CanvasTextDirection.RightToLeftThenTopToBottom,
        };

        private CanvasHorizontalAlignment GetCanvasHorizontalAlignment(FormattedTextProperties textProperties) => textProperties.MutableProperties.HorizontalTextAlignment switch
        {
        ...
        private CanvasTextTrimmingGranularity GetTrimmingGranularity(FormattedTextProperties textProperties) => textProperties.MutableProperties.TextTrimming switch
        {
        ...
        private CanvasWordWrapping GetWordWrapping(FormattedTextProperties textProperties) => textProperties.MutableProperties.TextWrapping switch
        {
        ...
        private CanvasDrawTextOptions GetOptions(FormattedTextProperties textProperties)
        {
            ...
            if (!textProperties.ImmutableProperties.UseLayoutRounding) options |= CanvasDrawTextOptions.NoPixelSnap;
            if (textProperties.MutableProperties.TextTrimming == TextTrimming.Clip) options |= CanvasDrawTextOptions.Clip;
