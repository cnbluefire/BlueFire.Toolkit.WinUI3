...
{
    internal partial class TextView : FrameworkElement
    {
        /*
        ...
        private void XamlRoot_Changed(XamlRoot sender, XamlRootChangedEventArgs args)
        {
            ...
            if (!prop.HasValue || prop.Value.MutableProperties.RasterizationScale != sender.RasterizationScale)
            {
                // DPI Changed
                MakeDirty();
            }
        ...
        [MemberNotNull(nameof(alphaMaskSurface), nameof(alphaMaskSurfaceBrush), nameof(textRenderer))]
        ...
        private Size UpdateTextLayout(Size availableSize)
        {
            ...
            if (ShouldRecreateFormattedText(currentTextProps, props))
            {
            ...
            var textLayoutSize = new Size(availableSize.Width - props.MutableProperties.StrokeThickness * 2,
                availableSize.Height - props.MutableProperties.StrokeThickness * 2);
            ...
            if (formattedText == null)
            {
                formattedText = new FormattedText(
                    ...
                    null,
                    props.MutableProperties.FlowDirection,
            ...
            formattedText.TextWrapping = props.MutableProperties.TextWrapping;
            formattedText.TextTrimming = props.MutableProperties.TextTrimming;
            formattedText.TextAlignment = props.MutableProperties.HorizontalTextAlignment;
        ...
        private Size UpdateLineVisuals()
        {
            ...
            try
            {
                ...
                var scale = (float)props.MutableProperties.RasterizationScale;
                ...
                textRenderer.Update(
                    ...
                    props.MutableProperties.StrokeThickness,
                    props.MutableProperties.RasterizationScale,
                    props.ImmutableProperties.IsColorFontEnabled);
